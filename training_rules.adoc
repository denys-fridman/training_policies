...
|===
 ...
 |deepseekv3_671b |adamw |moe_aux_loss_coeff |0.01 |Scaling factor for the complementary sequence-wise balance loss, used to prevent extreme expert imbalance within a single sequence. |TODO |v6.0
|===
